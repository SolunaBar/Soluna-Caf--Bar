...
export const LanguageProvider = ({ children }: LanguageProviderProps) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    es: {
      ...
      'menu.cocktail7.desc': 'Bombay Sapphire con jarabe artesanal de menta, un delicado toque de sal y pimienta.',
      'menu.cocktail8': 'Bellini',
      'menu.cocktail8.desc': 'Elegante cóctel italiano elaborado con puré de melocotón y cava frío, refrescante, afrutado y delicadamente burbujeante.',
    ...
    en: {
      ...
      'menu.cocktail7.desc': 'Bombay Sapphire gin with homemade mint syrup, finished with a subtle touch of salt and pepper.',
      'menu.cocktail8': 'Bellini',
      'menu.cocktail8.desc': 'An elegant Italian cocktail made with peach purée and chilled cava, refreshingly fruity with delicate bubbles.',
      'menu.cocktail9': 'Vermouth',
      'menu.cocktail9.desc': '',
