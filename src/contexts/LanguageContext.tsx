...
export const LanguageProvider = ({ children }: LanguageProviderProps) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    es: {
      ...
      // Bebidas
      'menu.drink1': 'Refresco / Soft drinks',
      'menu.drink1.desc': 'Cocacola, cocacola zero, fanta limon, fanta naranja',
      'menu.drink2': '7up',
      'menu.drink2.desc': '',
      'menu.drink3': 'Tonica Bliss',
      'menu.drink3.desc': '',
      'menu.drink4': 'Fevertree',
      'menu.drink4.desc': '',
      'menu.drink5': 'Acuarius',
      'menu.drink5.desc': '',
      'menu.drink6': 'Fuse tea',
      'menu.drink6.desc': '',
      'menu.drink7': 'Solan con gas / Fizzy Water',
      'menu.drink7.desc': '',
