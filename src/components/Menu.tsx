...
const Menu = () => {
  ...
  const menuData: Record<MenuCategory, MenuItem[]> = {
    desayunos: [
      ...
      { name: t('menu.breakfast4'), description: t('menu.breakfast4.desc'), price: '4€' },
    ],
    brunch: [
